                ...
                <div class="col-6 col-md-8 col-lg-6">
                  <div class="card h-100 hover-scale-up cursor-pointer">
                    <div class="card-body d-flex flex-column align-items-center">
                      ...
                      <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">КОЛИЧЕСТВО АДМИНИСТРАТОРОВ</div>
                ...
                <div class="col-6 col-md-8 col-lg-6">
                  <div class="card h-100 hover-scale-up cursor-pointer">
                    <div class="card-body d-flex flex-column align-items-center">
                      ...
                      <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">КОЛИЧЕСТВО НОВОСТЕЙ</div>
                      <div class="text-primary cta-4">
                        <?php
